...
与扁平行阀针/阀针镀层等 hrspec_valve_* 规格字段独立；型号与 BOM 拆成多分类扁平存储，级联由前端组合。
"""
...
SEL_DRIVE_SYSTEM_DICT_SEED: list[tuple[str, str, int, list[str]]] = [
    ...
    (
        ...
        "在气缸板上开孔的驱动器-型号",
        8305,
        ["HS40", "VC58", "VC68", "VC78", "VC88", "FEP30"],
    ),
    (
    ...
    ("hrspec_drv_manifold_tubing", "固定在分流板上-管材类型", 8310, ["铁氟龙管", "铁管"]),
    (
    ...
    ("hrspec_drv_guide_sleeve", "导向套-规格", 8312, list(_PHI_SLEEVE)),
]
