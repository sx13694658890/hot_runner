...
SEL_HOT_NOZZLE_DICT_SEED: list[tuple[str, str, int, list[str]]] = [
    ...
    ("hrspec_hnz_gate_diameter", "热咀咀头-胶口套", 8211, list(_GATE_PHI)),
    ...
    ("hrspec_hnz_valve_bushing", "热咀咀头-阀口套", 8215, list(_GATE_PHI)),
    ("hrspec_hnz_outer_circlip", "热咀咀头-外卡簧", 8216, list(_SECTION_SIZES)),
    ("hrspec_hnz_insulation_ring", "热咀咀头-隔热帽", 8217, ["PI", "PEEK", "铍合金"]),
